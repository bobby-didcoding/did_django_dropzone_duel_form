...
from .models import UserProfile, UserToken, ImageComment
...
'''
Basic model-form for our image model.
'''
class ImageCommentForm(forms.ModelForm):

	upload_description = forms.CharField(max_length=100, required=True,
		widget=forms.TextInput(attrs={'placeholder': '*Upload comments..'}))
